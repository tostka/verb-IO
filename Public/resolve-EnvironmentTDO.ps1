...
function resolve-EnvironmentTDO {
    ...
    * 4:13 PM 4/4/2025 init
    ...
    Relies on parameter-fed proxy variable copies from source call, returns a PSCustomObject with an array of profile specifications on the parameters provided, for use steering logging, file exports and other pathed tasks. 

    Example return from a call from a Script: 
    ```powershell

    write-verbose "Sample Call:" ; 
    ...
    write-verbose "splatted proxy variables captured above"; 
    $pltRvEnv=[ordered]@{
    ...
    Returned object properties (when called from a script .ps1 file):
        PSCmdletproxy          : System.Management.Automation.PSScriptCmdlet
        PSScriptRootproxy      : D:\scripts
        PSCommandPathproxy     : D:\scripts\tmp_func.ps1
        MyInvocationproxy      : System.Management.Automation.InvocationInfo
        PSBoundParametersproxy : {[Verbose, True]}
        runSource              : ExternalScript
        CmdletName             : tmp_func.ps1
        PSParameters           : @{Verbose=True}
        ParamsNonDefault       : 
        isScript               : True
        ScriptName             : D:\scripts\tmp_func.ps1
        ScriptBaseName         : tmp_func.ps1
        ScriptNameNoExt        : tmp_func
        ScriptDir              : D:\scripts
        isScriptUnpathed       : True
        isFunc                 : False

    Returned object properties (when called from an Advanced Function, ipmo'd from a .ps1 file):
        Name                           Value                                                                                                                                                                                            
        ----                           -----                                                                                                                                                                                            
        PSCmdletproxy                  System.Management.Automation.PSScriptCmdlet                                                                                                                                                      
        PSScriptRootproxy              D:\scripts                                                                                                                                                                                       
        ...
        CmdletName                     functest                                                                                                                                                                                         
        PSParameters                   @{Verbose=True}                                                                                                                                                                                  
        ParamsNonDefault               {InformationAction, InformationVariable, PipelineVariable}                                                                                                                                       
        isFunc                         True                                                                                                                                                                                             
        FuncName                       functest                                                                                                                                                                                         
        isFuncAdv                      True                                                                                                                                                                                             
        FuncDir                        D:\scripts                                                                                                                                                                                       
    ...
    Returned object properties (when called from a Basic Function, ipmo'd from a .ps1 file):
        Name                           Value                                                                                                                                                                                            
        ----                           -----                                                                                                                                                                                            
        PSCmdletproxy                                                                                                                                                                                                                   
        PSScriptRootproxy              D:\scripts                                                                                                                                                                                       
    ...
    .OUTPUTS
    PsCustomObject containing resolved enviornmnent information about the parameters passed in. 
    .EXAMPLE
    ...
    PS> write-host "Returned `$rvEnv:`n$(($rvEnv|out-string).trim())" ; 
        ...
        15:54:17:resolve-EnvironmentTDO w
        Name                           Value                                                                                                                                                                                            
        ----                           -----                                                                                                                                                                                            
        PSCmdletproxy                  System.Management.Automation.PSScriptCmdlet                                                                                                                                                      
        PSScriptRootproxy              D:\scripts                                                                                                                                                                                       
    ...
    Demo call, collecting proxy copies of the local Automatic Variables, and passing them in as a splat to resolve-EnvironmentTDO(). (The proxied variables are returned along with up[dated environment profiling information). 
    .LINK
    ...
    #>
    [CmdletBinding()]
    [Alias('rvEnv','resolve-Environment')]
    PARAM(
